...
function( ci_make_python_binding)
  ...
  pybind11_add_module(${ARG_APP_NAME} ${ARG_SOURCES})
  ...
  add_dependencies(${ARG_APP_NAME} cinder ${ARG_LIBRARIES})
	target_link_libraries( ${ARG_APP_NAME} PRIVATE cinder ${ARG_LIBRARIES} )
  set_target_properties(cinder PROPERTIES POSITION_INDEPENDENT_CODE TRUE)
	...
	foreach( block ${ARG_BLOCKS} )
		...
		if( blockName )
			...
			if( TARGET "${blockName}" )
				...
				target_link_libraries( ${ARG_APP_NAME} PRIVATE "${blockName}" )
			else()
				...
				if( ${blockName}_LIBRARIES )
					target_link_libraries( ${ARG_APP_NAME} PRIVATE ${${blockName}_LIBRARIES} )
				endif()
			endif()
